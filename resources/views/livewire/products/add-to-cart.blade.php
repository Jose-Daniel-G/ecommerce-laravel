            ...
            <div class="grid md:grid-cols-2 gap-6">
                ...
                <div class="col-span-1">
                    ...
                    <div class="flex items-center space-x-6 mb-6" x-data="{ qty: @entangle('qty') }">
                        ...
                        <button class="btn btn-gray" x-on:click="qty=qty+1">+</button>
                    </div>
                    <button class="btn btn-blue w-full mb-6" wire:click="add_to_cart" wire:loading.attr="disabled">Agregar al carrito</button>
