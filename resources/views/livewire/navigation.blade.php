    ...
    <header class="bg-blue-600">
        <x-container class="px-4 py-4">
            <div class="flex justify-between items-center space-x-8">
                <button class="text-xl md:text-3xl" x-on:click="open = true"><i class="fas fa-bars text-white"></i></button>
                <h1 class="text-white">
                    ...
                    <x-dropdown>
                        ...
                        <x-slot name="content">
                            ...
                            <div class="px-4 py-2">
                                ...
                                <p class="text-sm text-center mt-2">No tienes cuenta?<a href="{{route('register')}}"  class="text-blue-600 hover:underline">Registrate</a></p>
                            </div>
                            @else
